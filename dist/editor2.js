  ...
  function () {
    ...
    (0, _createClass2.default)(ItalicInlineTool, [{
      ...
      value: function render() {
        ...
        this.nodes.button.type = 'button';
        this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier);
        this.nodes.button.appendChild(_dom.default.svg('italic', 34, 34));
        return this.nodes.button;
      }
      /**
  ...
  function () {
    ...
    (0, _createClass2.default)(LinkInlineTool, [{
      ...
      value: function render() {
        ...
        this.nodes.button.type = 'button';
        this.nodes.button.classList.add(this.CSS.button, this.CSS.buttonModifier);
        this.nodes.button.appendChild(_dom.default.svg('link', 34, 34));
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  if (true) {
    !(__WEBPACK_AMD_DEFINE_ARRAY__ = [exports, __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ "./node_modules/@babel/runtime/helpers/classCallCheck.js"), __webpack_require__(/*! @babel/runtime/helpers/createClass */ "./node_modules/@babel/runtime/helpers/createClass.js"), __webpack_require__(/*! @babel/runtime/helpers/possibleConstructorReturn */ "./node_modules/@babel/runtime/helpers/possibleConstructorReturn.js"), __webpack_require__(/*! @babel/runtime/helpers/getPrototypeOf */ "./node_modules/@babel/runtime/helpers/getPrototypeOf.js"), __webpack_require__(/*! @babel/runtime/helpers/inherits */ "./node_modules/@babel/runtime/helpers/inherits.js"), __webpack_require__(/*! ../__module */ "./src/components/__module.ts"), __webpack_require__(/*! ../utils */ "./src/components/utils.ts"), __webpack_require__(/*! ../selection */ "./src/components/selection.ts")], __WEBPACK_AMD_DEFINE_FACTORY__ = (factory),
				__WEBPACK_AMD_DEFINE_RESULT__ = (typeof __WEBPACK_AMD_DEFINE_FACTORY__ === 'function' ?
				(__WEBPACK_AMD_DEFINE_FACTORY__.apply(exports, __WEBPACK_AMD_DEFINE_ARRAY__)) : __WEBPACK_AMD_DEFINE_FACTORY__),
				__WEBPACK_AMD_DEFINE_RESULT__ !== undefined && (module.exports = __WEBPACK_AMD_DEFINE_RESULT__));
  } else { var mod; }
})(this, function (_exports, _classCallCheck2, _createClass2, _possibleConstructorReturn2, _getPrototypeOf2, _inherits2, _module, _utils, _selection) {
  "use strict";
...
var __WEBPACK_AMD_DEFINE_FACTORY__, __WEBPACK_AMD_DEFINE_ARRAY__, __WEBPACK_AMD_DEFINE_RESULT__;(function (global, factory) {
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(ConversionToolbar, [{
      ...
      value: function leaf() {
        var direction = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 'right';
        var toolsElements = Array.from(this.nodes.tools.childNodes);
        this.focusedButtonIndex = _dom.default.leafNodesAndReturnIndex(toolsElements, this.focusedButtonIndex, direction, ConversionToolbar.CSS.conversionToolFocused);
      }
      /**
      ...
      key: "dropFocusedButton",

      /**
       * Drops focused button
       */
      value: function dropFocusedButton() {
      ...
      value: function () {
        ...
        _regenerator.default.mark(function _callee(replacingToolName) {
          ...
          var currentBlockClass, currentBlockName, savedBlock, blockData, replacingTool, exportData, exportProp, cleaned, newBlockData, importProp;
          return _regenerator.default.wrap(function _callee$(_context) {
            while (1) {
              switch (_context.prev = _context.next) {
                case 0:
      ...
      value: function addTools() {
        ...
        for (var toolName in tools) {
          ...
          var toolToolboxSettings = toolClass[api.TOOLBOX];
          var conversionConfig = toolClass[api.CONVERSION_CONFIG];
          /**
      ...
      get: function get() {
        ...
        return this.nodes.tools.childNodes[this.focusedButtonIndex];
      }
    }], [{
      key: "CSS",
      get: function get() {
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Toolbox, [{
      ...
      value: function showTooltip(button, toolName) {
        ...
        var topOffset = 15; // Math.floor(this.Editor.BlockManager.currentBlock.holder.offsetHeight / 2);
  ...
  function (_Module) {
    ...
    (0, _createClass2.default)(Tools, [{
      ...
      value: function construct(tool, data) {
        ...
        var config = this.toolsSettings[tool][this.apiSettings.CONFIG] || {}; // Pass placeholder to initial Block config
  ...
  function () {
    ...
    (0, _createClass2.default)(Util, null, [{
      ...
      value: function log(msg) {
        ...
        var editorLabelText = "Editor.js ".concat("2.15.0");
